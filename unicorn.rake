...
# place this in the appropriate directory lib/tasks

require 'tty'

namespace :unicorn do

  # legacy unicorn vs unicorn_rails
  def unicorn
    'unicorn'
  end

  def current_dir
    '/var/www/PROJECT_NAME/current'
  end
  ...
  task :start do
    Dir.chdir(current_dir) do
      if system("#{unicorn} -c #{current_dir}/config/unicorn.rb -D")
  ...
  task :obtain_pid do
    Dir.chdir(Rails.root) do
      @pid_file = "/var/www/PROJECT_NAME/shared/tmp/pids/unicorn.pid"
